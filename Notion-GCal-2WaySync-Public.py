...
if len(resultList) > 0:
    ...
    for i, el in enumerate(resultList):
        ...
        CurrentCalList.append(
            el["properties"][Current_Calendar_Id_Notion_Name]["rich_text"][0]["text"][
                "content"
            ]
        )
...
for i in range(len(new_notion_start_datetimes)):
    ...
    if (
        notion_end_datetimes[i] != gCal_end_datetimes[i]
        ...
        **{
            ...
            "properties": {
                Current_Calendar_Id_Notion_Name: {  # this is the text
                    "rich_text": [{"text": {"content": CalIds[CalNames.index(gCalId)]}}]
                },
                ...
                **{
                    ...
                    "properties": {
                        ...
                        ExtraInfo_Notion_Name: {
                            "type": "rich_text",
                            "rich_text": [{"text": {"content": calDescriptions[i]}}],
                        },
                        GCalEventId_Notion_Name: {
                            "type": "rich_text",
